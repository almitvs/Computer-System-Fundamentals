...
public:
  ...
  BigInt(std::vector<uint64_t> vals, bool negative);
  //! Copy constructor.
  //!
...
private:
  //! Function to find the most significant bit in case of padding.                                                                                                                                           
  //!                                                                                                                                                                                                          
  //! @param num
  //!        the BigInt number
  //! @return int index of the lead
  int find_lead_bit(const BigInt &num) const;

  //! Helper function to add the magnitudes of two BigInts                                                                                                                                                
  //!                                                                                                                                                                                                          
  //! @param lhs & rhs                                                                                                                                                
  //!        the BigInts to add                                                                                                                                           
  //! @return the sum of the BigInts
  BigInt add(const BigInt &lhs, const BigInt &rhs) const;

  //! Helper function to determine whether the first of the magnitudes of two BigInts is greater                                                                                                              
  //!                                                                                                                                                                                                          
  //! @param lhs & rhs                                                                                                                                                                                         
  //!        the BigInts to compare                                                                                                                                                                           
  //! @return bool whether lhs is greater or not   
  bool greater_magnitude(const BigInt &lhs, const BigInt &rhs) const;

  //! Helper function to subtract the magnitudes of two BigInts                                                                                                                                               
  //!                                                                                                                                                                                                          
  //! @param lhs & rhs                                                                                                                                                                                         
  //!        the BigInts to subtract                                                                                                                                                                           
  //! @return the sum of the BigInts   
  ...
  //!             in order from less-significant to more-significant                                                                                                                                           
  //! @param negative if true, the value is negative
  BigInt divide_by_2() const;

  //! Helper function for bit shift                                                                                                                                               
  std::pair<BigInt, uint64_t> divmod(uint64_t divisor) const;

  //! Function to check if a BigInt is == 0                                                                                                                                                
  //!                                                                                                                                                       
  //! @return bool if the BigInt is zero or not
  bool is_zero() const;
